/* SAFER.H - block-cipher algorithm SAFER
 *
 ...
 * CHANGE HISTORY:
 *
 * $Header: safer.h: Revision: 1: Author: tharms: Date: Wednesday, September 30, 2009 2:48:26 PM$
 * $Log$
 ...
 * Cjakeway - Tuesday, July 11, 2006 10:07:52 AM
 * Fixed up Log wildcard in file header for use with Surround SCM.
 * 
 * 2     6/27/03 10:15a Alehmann
 * Add extern C for cplus plus
 */
